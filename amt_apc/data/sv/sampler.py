...
def _get_style_vectors_path():
    """Get the path to the style vectors file."""
    return get_package_root() / config.path.style_vectors
...
class Sampler:
    def __init__(self, variances=(0., 0., 0.), windows=(0.5, 0.1, 0.5)):
        ...
        path_style_vectors = _get_style_vectors_path()
