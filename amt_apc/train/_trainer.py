...
from amt_apc.models import load_model, save_model
from amt_apc.train._loss import loss_fn
from amt_apc.utils import config, get_package_root


def _get_checkpoints_dir():
    """Get the checkpoints directory path."""
    return get_package_root() / config.path.checkpoints
...
def train(
    ...
    """
    dir_checkpoints = _get_checkpoints_dir()
    model.train()
